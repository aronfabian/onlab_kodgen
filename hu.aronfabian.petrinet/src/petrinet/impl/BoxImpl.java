 ...
 * </p>
 * <ul>
 *   <li>{@link petrinet.impl.BoxImpl#getId <em>Id</em>}</li>
...
public class BoxImpl extends MinimalEObjectImpl.Container implements Box {
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.BOX__ID, oldId, id));
	}
	...
	public EList<Place> getPlace() {
		if (place == null) {
			place = new EObjectResolvingEList<Place>(Place.class, this, PetrinetPackage.BOX__PLACE);
		}
		return place;
	}
